          ...
          <div className="relative group">
            ...
            <div className="absolute left-0 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
              <div className="py-1" role="menu" aria-orientation="vertical">
                <Link to="/uae" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-brand-purple font-medium">UAE</Link>
            ...
            <div className="pt-2 pb-2 border-t border-brand-grey/50">
              ...
              {isLocationsOpen && (
                <div className="flex flex-col space-y-3 pl-2 mb-2">
                  <Link to="/uae" className="text-base font-medium" onClick={() => setIsOpen(false)}>UAE</Link>
